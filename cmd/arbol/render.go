...
// visualLength computes string length without ANSI sequences.
// Optimization: Processes string in a single pass without allocating a stripped copy, and uses a fast path for common ASCII chars.
...
// Optimization: Preallocates string builder to avoid repeated slice reallocations.
