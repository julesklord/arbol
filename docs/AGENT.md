...
1. The shell script is located under `scripts/tinyfetch.sh` and has no external dependencies.
...
3. Run `shellcheck scripts/tinyfetch.sh` before committing any changes to the shell script.
